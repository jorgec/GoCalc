...
<script>
    ...
    import {loadSpecificationsFromPanelboard, recalcSpecifications} from "../utils/mutators.js";

    import {modalImage, showMaterialsInventory} from "../stores/uiStore";
    ...
    import {ExposePath, LoadMaterialInventory, SaveMaterialInventory} from "../../wailsjs/go/main/App.js";
    import {brands, inventory, wireTypes} from "../stores/materialInventoryStore.js";
...
<div class="container-fluid m-2 pl-4">
    ...
    {:else}
        {#if $currentPanelBoard !== null}
            <div class="w-full bg-white px-4 py-3 shadow-md rounded-tr-2xl rounded-tl-2xl border-b border-gray-200">
                <h2 class="text-lg font-medium tracking-wide text-gray-800">
                    {$panelBoardList[$currentPanelBoard]}
                </h2>
            </div>
            <div class="h-20 py-4">
                <div class="my-4 p-2 px-3">
                ...
                <div class="my-4 p-2 px-3">
                    ...
                    {#if wireRecommendation}
                        <div class="my-4 p-4 text-gray-900 bg-green-200">
                            ...
                            Use <strong>2 - <a href="#!" on:click|preventDefault={() => modalImage.set(wire_table)}
                                               class="underline">
                            ...
                            in
                            <strong>
                                <a href="#!" on:click|preventDefault={() => modalImage.set(conduit_table)}
                                   class="underline">
                        ...
                        <div class="my-4 p-4 text-gray-900 bg-green-200">
                            Use
                            <strong>1 -
                                <a href="#!" on:click|preventDefault={() => modalImage.set(overcurrent_protection)}
                                   class="underline">
