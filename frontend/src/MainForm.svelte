        ...
        <div class="flex-1 flex justify-end items-center gap-2">
            <button
                ...
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3v18h18V9l-6-6H3zm9 13a2 2 0 110-4 2 2 0 010 4zm-1-9V3l5 5h-5z"/>
                </svg>
            </button>
            <button class="bg-blue-500 hover:bg-blue-700 text-white p-2 rounded inline-flex items-center">
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 21h6V11l-3-3-3 3v10zm0 0V11l-3 3m3-3l3 3m-6 0h6"/>
                </svg>
    ...
    <div class="flex flex-1 bg-gray-200">
        ...
        <aside class="transition-all h-full duration-500 bg-white {showConsole ? 'w-1/3' : 'hidden'}">
            <div class="container-fluid m-2 pl-4">
                <div class="h-20 py-4">
                    <h3 class="block text-gray-700 font-bold mb-2">Lighting Load at {totalLoad}VA per m<sup>2</sup>: <code>{loadByOccupancy} VA</code></h3>
